...
//   - An error if reading fails or message length is invalid
...
//
// Returns an error if writing fails or message is too large.
...
// Write writes data to the connection in a thread-safe manner.
