...
// Parameters:
//   - priKey: PEM-encoded PKCS8 or PKCS1 private key
// Returns:
//   - *RSADecrypter: initialized decrypter instance
...
// Parameters:
//   - pubKey: PEM-encoded PKIX public key
// Returns:
//   - *RSAEncrypter: initialized encrypter instance
//   - error: error if key parsing fails
...
// Parameters:
//   - originData: the plaintext data to encrypt
// Returns:
...
// Parameters:
//   - key: encryption key, must be 16, 24, or 32 bytes (for AES-128, AES-192, or AES-256)
// Returns:
//   - *AESGCMCrypter: initialized crypter instance
//   - error: error if key length is invalid or cipher creation fails
...
// Returns format: nonce + ciphertext + authentication tag
// Parameters:
//   - plaintext: the data to encrypt
// Returns:
//   - []byte: encrypted data with nonce and authentication tag
//   - error: error if nonce generation or encryption fails
...
// Parameters:
//   - ciphertext: encrypted data containing nonce, ciphertext, and authentication tag
// Returns:
//   - []byte: decrypted plaintext
//   - error: error if ciphertext is invalid, tag verification fails, or decryption fails
...
//   - key: encryption key, must be 16, 24, or 32 bytes (for AES-128, AES-192, or AES-256)
// Returns:
//   - *AESCTRCrypter: initialized crypter instance
//   - error: error if key length is invalid
...
//   - plaintext: the data to encrypt
// Returns:
//   - []byte: encrypted data with prepended initialization vector (IV)
//   - error: error if cipher creation or IV generation fails
...
// Parameters:
//   - ciphertext: encrypted data with prepended IV
// Returns:
//   - []byte: decrypted plaintext
//   - error: error if ciphertext is too short or cipher creation fails
